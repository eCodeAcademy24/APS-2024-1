...
//        на дискусијата.(int id), популарност (int popularity), како и број на корисници кои се активни (int users)
...
//        За секоја дискусија може да се пресмета нејзината важност како производ на нејзината популарност и бројот на
//        активни корисници.
...
//        int minImportance = leastImportantFinance.element.calculateImportance();
        ...
        health.delete(mostImportantHealth);
