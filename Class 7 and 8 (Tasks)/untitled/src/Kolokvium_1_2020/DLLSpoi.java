...
// Да се констурира ново двојно поврзана листа којашто ќе ги содржи сите елементи од двете листи и тоа во опаѓачки редослед. При решавањето на задачата не смее
// да се користи сортирање на листи.
...
public class DLLSpoi {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(lista2.toStringR());
    }
